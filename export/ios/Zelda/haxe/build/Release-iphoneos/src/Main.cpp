...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(18)
	this->framerate = (int)30;
	HX_STACK_LINE(17)
	this->zoom = (int)-1;
	HX_STACK_LINE(16)
	this->initialState = hx::ClassOf< ::PlayState >();
	HX_STACK_LINE(15)
	this->gameHeight = (int)284;
	HX_STACK_LINE(14)
	this->gameWidth = (int)160;
	HX_STACK_LINE(31)
	super::__construct();
	HX_STACK_LINE(33)
...
Void Main_obj::setupGame( ){
{
		...
		HX_STACK_LINE(67)
		::Global_obj::gameHeight = this->gameHeight;
		HX_STACK_LINE(68)
		::Global_obj::gameWidth = this->gameWidth;
		HX_STACK_LINE(69)
		::Global_obj::gameZoom = this->zoom;
		HX_STACK_LINE(72)
